...
\toprule
Seed & Model & COCO/GQA/Hard & BEM & Supp. & Wrong Rej. & Obj/Attr/Rel & JSON Obj. & Parse Fail \\
\midrule
13 & \answerdpo{} & 96.9 / 77.2 / 95.1 & 19.4 & 90.7 & 33.0 & 42.1 / 44.3 / 10.4 & 100.0 & 0.0 \\
13 & \dualtwok{} & 97.0 / 76.9 / 95.0 & 20.3 & 95.7 & 71.8 & 96.0 / 85.9 / 30.4 & 100.0 & 0.0 \\
42 & \answerdpo{} & 97.0 / 76.8 / 95.0 & 18.0 & 90.7 & 34.3 & 45.2 / 45.0 / 10.4 & 100.0 & 0.0 \\
42 & \dualtwok{} & 97.0 / 77.1 / 94.9 & 19.4 & 95.2 & 70.3 & 96.0 / 85.9 / 25.6 & 100.0 & 0.0 \\
97 & \answerdpo{} & 97.0 / 77.0 / 95.1 & 19.0 & 90.2 & 33.3 & 42.9 / 45.0 / 9.6 & 100.0 & 0.0 \\
97 & \dualtwok{} & 97.0 / 76.9 / 95.0 & 19.5 & 95.3 & 68.5 & 96.8 / 85.2 / 20.0 & 100.0 & 0.0 \\
\bottomrule
\end{tabular}
\captionof{table}{Seed-stability results for the two trained groups needed
for the central conclusion. Values are percentages. JSON Obj. reports whether
the raw evidence-probe output contains a parseable JSON object; decoding is
not constrained.}
\label{tab:app_seed}
\end{minipage}
\end{center}

Table~\ref{tab:app_paraphrase} reports the row-preserving paraphrase check.
It rewrites the evaluation question and candidate-evidence wording, but keeps
the locked probe images, rows, and labels. This is weaker than a human-written
evidence benchmark, yet it tests whether the main wrong-evidence gain survives
...
\toprule
Model & Supp. & Wrong Rej. & Obj/Attr/Rel & JSON Obj. & Parse Fail \\
\midrule
Base Instruct & 86.0 & 65.8 & 71.4 / 64.4 / 61.6 & 100.0 & 0.0 \\
\answerdpo{} & 90.0 & 61.8 & 66.7 / 60.4 / 58.4 & 100.0 & 0.0 \\
\dualtwok{} & \textbf{90.0} & \textbf{73.2} & \textbf{91.3} / \textbf{68.5} / \textbf{60.8} & 100.0 & 0.0 \\
\bottomrule
\end{tabular}
\captionof{table}{Paraphrased CEPO-Probe check for the three anchor models.
Values are percentages. The probe reuses the locked 600 supported and 400
wrong-evidence rows with rewritten prompt/evidence wording.}
